...
namespace MinImage
{
    ...
    {
        private string[] generatingCommands = {"Generate", "Input", "CustomGen1", "CustomGen2", "CustomGen3"};
        private string[] processingCommands = {"Output", "Blur", "RandomCircles", "Room", "ColorCorrection", "GammaCorrection", "CustomProc1", "CustomProc2", "CustomProc3" };
